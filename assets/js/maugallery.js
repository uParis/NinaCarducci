(function($) {
    ...
    $.fn.mauGallery.methods = {
        ...
        openLightBox(element, lightboxId) {
            // Appliquer les styles en une seule chaîne
            $(`#${lightboxId}`).css({
                'opacity': '1',
                'display': 'block'
            })
        ...
        prevImage(){
			// Trouver l'image active (actuellement affichée dans la lightbox)
			let activeImage = $(".lightboxImage").attr("src")

			// Obtenir le tag actif
			let activeTag = $(".tags-bar span.active-tag").data("images-toggle")

			// Créer une collection d'images correspondant au tag actif
			...
			// Si aucune image n'est trouvée, on arrête la fonction
